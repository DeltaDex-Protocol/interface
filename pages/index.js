...
import {
  ...
  MyPositions,
  AllPositions,
} from '../app/components/screens/dapp/index'
...
export default function App() {
  ...
  return (
    <div className="max-w-6xl mx-6 xl:mx-auto ">
      <Header
        walletAddress={walletValue.wallet}
        connect={walletValue.request}
      />
      <div className="md:flex md:space-x-10">
        ...
        />
        <div className="mt-10 ">
          {activeUnit == 'VanillaOptions' && (
            <VanillaOptionForm ethPrice={ethPrice} />
          )}
          {activeUnit == 'CurvedOptions' && (
            <CurvedOptionsForm ethPrice={ethPrice} />
          )}
