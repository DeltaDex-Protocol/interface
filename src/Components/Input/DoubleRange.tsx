  ...
  return (
    <div className={styles.container}>
      <input
        ...
        className={
          `${styles.thumb} ${styles['thumb--left']}`
        }
      ...
      <input
        ...
        className={
          `${styles.thumb} ${styles['thumb--right']}`
        }
      />
      ...
      <div className={styles.slider}>
        ...
        >
          <span className="font-sans font-bold">{minVal}</span>
        </div>
        <div
          className={styles['slider__right-value']}
        >
          <span className="font-sans font-bold">{maxVal}</span>
        </div>
      </div>
    </div>
  )
