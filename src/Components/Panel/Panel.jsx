...
const SidebarMenuInfos = {
    "VanillaOptions": {label: "Vanilla options", description: "Replicate your vanilla option"},
    "CurvedOptions": {label: "Curved options", description: "Hedge against impermanent losses"},
    "YourPositions": {label: "Your positions", description: "Click to see your previous replications"},
    "AllPositions": {label: "All positions", description: "Check users' positions close to replication"},
}
...
const SidebarUnit = ({Menu, onChangeToggle, toggle}) => {
    ...
    return (
        <div className={`relative mt-6 rounded-xl ${bg_color} shadow py-12 px-20 flex flex-col`} onClick={() => onChangeToggle(Menu)}>
            <span className={`absolute left-3 top-3 ${text_color} font-normal text-lg`}>{SidebarMenuInfos[Menu].label}</span>
            <span className={`absolute left-3 top-11 ${text_color} font-light leading-tight text-sm w-40`}>{SidebarMenuInfos[Menu].description}</span>
        </div>
    )
                    ...
                    <>  
                        <div className='flex justify-between'>
                            <div className='mb-5 px-4 py-2 bg-indigo-400 w-1/2 h-24 rounded-xl flex flex-col'>
                                <span className='text-xl font-medium text-white mt-2'>Replicate your Vanilla option</span>
